...
if(!empty($_POST['username']) and !empty($_POST['testname'])) {
...
<body>
	...
	<div><a href="certificate.php?testname=<?php echo($testname)?>&username=<?php echo($username) ?>&result=<?php echo($result) ?>">Загрузить сертификат</a></div>
